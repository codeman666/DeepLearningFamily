...
from model import efficientnetv2_s as efficientnet
...
def main():
    ...
    net = efficientnet(num_classes=5)
    ...
    print(f"Number of parameters to optimize: {len(params)}")
    
    optimizer = optim.Adam(params,lr=0.001)
    
    best_acc = 0.0
    save_path = "./pre_efficientnetv2-s.pth"
